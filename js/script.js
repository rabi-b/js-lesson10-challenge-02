...
const studying = document.querySelector(".studying"); //new
const dance = document.querySelector(".dance");
const study = document.querySelector(".study"); //new
...
const learning = {
  ...
  stillStudying: function() { //new
    body.classList.add("focus");
    studying.classList.remove("hide")
